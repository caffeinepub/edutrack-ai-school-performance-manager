...
const features = [
  {
    ...
    desc: "Track every student's academic journey",
  },
  {
    icon: Brain,
    label: "AI-Powered Insights",
    desc: "Detect weak students and generate improvement plans",
  },
  {
    icon: BookOpen,
    label: "Marks & Feedback",
    desc: "Comprehensive records for all subjects",
  },
  {
    icon: Shield,
    label: "Secure Access Control",
    desc: "Role-based login for admins and teachers",
  },
];

export default function LoginPage() {
  const { login, isLoading: isBackendLoading } = useAuth();
  ...
  const isDisabled = isLoggingIn || isBackendLoading;
    ...
    >
      ...
      >
        <div>
          ...
          >
            AI-driven analytics to identify struggling students early and create
          ...
          <div className="bg-card rounded-2xl border border-border shadow-card p-8">
            <div className="mb-8">
              ...
              <p className="text-sm text-muted-foreground">
                Sign in with your credentials to access the school management
                dashboard.
              </p>
            </div>
